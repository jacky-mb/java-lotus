...
public class Pages {
    @DefaultUrl("https://portal-dev.nextcam.vn/")
    public static class Login extends PageObject {
        @FindBy(name = "merchantAlias")
        public static WebElementFacade MERCHANT_ID;
        @FindBy(name = "username")
        public static WebElementFacade USERNAME;
        @FindBy(name = "password")
        public static WebElementFacade PASSWORD;
        @FindBy(xpath = "//button[@type='submit']")
        public static WebElementFacade BUTTON_SUBMIT;
    }
